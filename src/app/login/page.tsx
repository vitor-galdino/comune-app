        ...
        <div className='sm:w-[470px] sm:px-0 container w-screen px-8'>
          <section className='flex flex-col items-center justify-center w-full h-screen'>
            ...
            >
              ...
              <label htmlFor="password" className='font-normal text-gray-700 mt-4'>Senha</label>
              <input
                className='outline-none max-w-[95%] sm:w-80 w-full text-base pb-1 border-b-2 border-gray-200 focus:border-branding-blue hover:border-branding-blue'
                type="password"
                id="password"
              ...
              <button type="submit" className='h-10 mb-4 mt-4 font-medium text-white transition-all duration-300 border bg-branding-blue rounded-xl hover:bg-white hover:text-branding-blue hover:border-branding-blue'>Entrar</button>
            </form>
