          ...
          <div className='flex gap-3 rounded-lg'>
            <div>
              <button onClick={handleDownloadPDF}
                className='flex items-center gap-2 px-2 py-2 font-semibold text-gray-500 bg-white rounded-lg shadow hover:text-blue-500 md:px-4'
              >
            ...
            <div>
              <button
                className='flex items-center gap-1 px-2 py-2 font-semibold text-gray-500 bg-white rounded-lg shadow hover:text-blue-500 md:px-4'
              >
